...
<Image loading='eager' src={img1} alt="Screenshot of Google Translate converting a KR in Hangul address to US in Latin" />
and US in Latin into KR in Hangul:
<Image loading='eager' src={img2} alt="Screenshot of Google Translate converting a US in Latin address to KR in Hangul" />
