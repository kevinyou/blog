...
## Generalizations
- Alternating patterns are not exciting if the viewer is paying attention to them, and the end result feels expected.
- Breaking alternating patterns is very exciting.
...
Randomness of a series can be measured with a [randomness test](https://en.wikipedia.org/wiki/Randomness_test), while satisfaction level is more subjective.
