...
<Image loading='eager' src={img1} alt="Screenshot of Naver Maps, where the name of the major road and minor roads are circled to indicate one is named after the other" />
